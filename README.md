...
| - Разрабатывал новые компоненты и улучшал существующие, внедрял и удалял фиче, писал PixelPerfect, Jest, Hermion тесты. - Принимал участие в оценке задач, планировании времени согласно Agile. - Активное участие в хакатоне, где разработали плагин для Figma. В несколько раз ускорило работу по верстке (особенно для новичков в проекте) и написании Storybook тестов.  |                   |
| ----------------------------------------------------------------| :---------------: |
| **Школа Разработки Интерфейсов ( буткэмп от Яндекс )**          | **06/2023 - 08/2023** |
| Лекции и задания по следующим темам:     |                      |
| Node.Js, Асинхронность, Git, Тулинг, TypeScript, React, NextJS, |                   |
| Доступность интерфейсов, Performance, Сборка,                   |                   |
| Тесты (jest, e2e, Hermione тесты)  Инфраструктура, Локализация. |                   |
| Спасибо организаторам за "плотный" буткэмп.                     |                   |
| ----------------------------------------------------------------| :---------------: |
| **АО ВАД. Разработчик интерфейсов.**                            | **10/2021 - 05/2023** |
| https://zaovad.ru/                                              |                   |
| Не было опыта. Работал на "пол ставки"                          |                   |
| Опыт нужно получать и я старался изо всех сил.                  |                   |
| ----------------------------------------------------------------| :---------------: |
| **Яндекс Практикум. Курс фронтенд-разработчик.**                | **01/2021 - 09/2021** |
| Освоены: HTML, CSS, JS, React, Redux.                           |                   |
