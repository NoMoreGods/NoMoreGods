...
| Лекции и задания по следующим темам: Node.Js, Асинхронность,    |                   |
| Git, Тулинг, TypeScript, React, NextJS, Тесты (jest, e2e,       |                   |
| Hermione тесты),Доступность интерфейсов, Performance, Сборка,   |                   |
|   Инфраструктура, Локализация                                   |                   |
| ----------------------------------------------------------------| :---------------: |
